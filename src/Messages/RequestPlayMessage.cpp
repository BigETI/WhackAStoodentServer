...
nonstd::span<const std::uint8_t> WhackAStoodentServer::Messages::RequestPlayMessage::Deserialize(nonstd::span<const std::uint8_t> data)
{
	nonstd::span<const std::uint8_t> next_bytes(WhackAStoodentServer::Messages::ASerializableMessage<WhackAStoodentServer::EMessageType::RequestPlay>::Deserialize(data));
